...
from mnist import test_images as load_images
from mnist import test_labels as load_labels
...
model.fit(train_huMoments,train_labels,batch_size = 128,epochs=50,class_weight = {0:8, 1:1},verbose=1,workers = 16,use_multiprocessing = True)
