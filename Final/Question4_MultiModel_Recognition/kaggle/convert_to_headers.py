...
Converts trained TFLite models to C header files for ESP32-CAM

Usage:
  python convert_to_headers.py

Input: models/*.tflite
Output: ../esp32_cam/digit_recognition/*_model.h
"""
...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, '..', 'esp32_cam', 'digit_recognition')
